    ...
    <main className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <Dialog open={showDialog} onOpenChange={setShowDialog}>
        <DialogContent className="sm:max-w-[600px]">
          <DialogHeader>
            <DialogTitle className="text-2xl font-bold">Room Created!</DialogTitle>
          </DialogHeader>
          <div className="space-y-6">
            <div className="flex items-center justify-between bg-gray-100 p-4 rounded-lg">
              <span className="text-xl font-semibold tracking-wider">{roomCode}</span>
              <Button 
                variant="ghost" 
                size="icon" 
      ...
      <Card className="max-w-4xl mx-auto shadow-lg">
        <CardHeader>
          <CardTitle className="text-3xl font-bold text-gray-800">Create Your Space</CardTitle>
          <CardDescription>Design a unique room for your gathering</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="mb-6">
          ...
          <div>
            <h2 className="text-xl font-semibold mb-4 text-gray-800">Choose Your Map</h2>
              ...
              {mapData.map((map) => (
                ...
                >
                  ...
                  <CardContent className="p-4">
                    <CardDescription>
                      <h3 className="text-lg font-bold text-slate-800 mb-1">{map.title}</h3>
